...
require_once NERDYWITHME_TOOLS_PATH . 'includes/class-nerdywithme-tools-admin.php';
require_once NERDYWITHME_TOOLS_PATH . 'includes/class-nerdywithme-tools-shortcodes.php';
...
class NerdyWithMe_Tools_Plugin {
	...
	public function enqueue_assets() {
		wp_enqueue_style(
			'nerdywithme-tools',
			NERDYWITHME_TOOLS_URL . 'assets/css/nerdywithme-tools.css',
			array(),
			(string) filemtime(NERDYWITHME_TOOLS_PATH . 'assets/css/nerdywithme-tools.css')
		);

		wp_enqueue_script(
			'nerdywithme-tools',
			NERDYWITHME_TOOLS_URL . 'assets/js/nerdywithme-tools.js',
			array(),
			(string) filemtime(NERDYWITHME_TOOLS_PATH . 'assets/js/nerdywithme-tools.js'),
			true
		);
	}
