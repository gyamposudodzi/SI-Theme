...
<div id="page" class="site">
	<header class="site-header">
		<div class="nwm-shell">
			...
			$search_enabled = nerdywithme_has_search_modal();
			...
			$search_posts = $search_enabled ? ($search_posts_slug ? nerdywithme_get_posts_by_category_name($search_posts_slug, 3) : nerdywithme_get_featured_posts(3)) : null;
			$search_categories = $search_enabled ? array_slice(nerdywithme_get_primary_categories(), 0, 6) : array();
			?>
